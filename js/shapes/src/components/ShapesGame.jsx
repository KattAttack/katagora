...
export class ShapesGame extends Component {
	...
	updateDashes(currentSecretLetter, i) {
		...
		// console.log("current Secret Letter", currentSecretLetter);
		// console.log("clicked letter count", this.state.correctClickedLetterCount);
		// console.log("UpdateDashes");
		// console.log("clicked Letters", this.state.correctClickedLetterCount);
		this.setState(prevState => {
			return {
				correctClickedLetterCount: prevState.correctClickedLetterCount + 1,
				guessedWord
			};
		});

		// console.log("finished running update dashes");
	}
					...
					{this.state.showShapes ? (
						...
						<div>
							...
							<LetterBank
								...
								wrongLetterCount={this.state.wrongLetterCount}
								svgObj={this.state.svgObj}
								correctClickedLetterCount={this.state.correctClickedLetterCount}
