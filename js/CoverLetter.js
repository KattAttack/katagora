...
export function CoverLetter() {
    return (
        <>
            ...
            <br />
                <br />
                Recently, I've been working on converting a Legacy React Web Application into a React/Electron one, to be used in
                uncovering SAP related risks. Please take a look at my resume for further details and alternate ways of contact c:
        </p>
        </>
    )
}